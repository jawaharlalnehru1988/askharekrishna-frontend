...
export const TOPICS: Topic[] = [
    {
        ...
        href: "/bhagavad-gita/topic/bgc",
        audioListId: "bgc" // Updated to match API
    },
    {
 ...
 */
export function getAudioItemsByListId(audioListId: string): AudioItem[] {
 ...
 */
export function getTopicByListId(audioListId: string): Topic | undefined {
